        ...
        <div class="row mb-5">
            ...
            <div class="col-sm-8">
                <h5 class="card-title mb-2">
                    <a href="" class="text-decoration-none"><?php echo $record[0]['ten_bhat'] ?></a>
                </h5>
                <p class="card-text"><span class=" fw-bold">Bài hát: </span><?php echo $record[0]['ten_bhat'] ?></p>
                <p class="card-text"><span class=" fw-bold">Thể loại: </span><?php echo $record[0]['ten_tloai'] ?></p>
                <p class="card-text"><span class=" fw-bold">Tóm tắt: </span><?php echo $record[0]['tomtat'] ?></p>
                <p class="card-text"><span class=" fw-bold">Nội dung: </span><?php echo $record[0]['tomtat'] ?></p>
                <p class="card-text"><span class=" fw-bold">Tác giả: </span><?php echo $record[0]['ten_tgia'] ?></p>
            </div>
        </div>
    </main>
